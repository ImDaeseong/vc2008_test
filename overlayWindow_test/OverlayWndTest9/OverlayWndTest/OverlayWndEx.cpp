...
void COverlayWndEx::UpdateDrawText()
{
    ...
    */
	...
	//텍스트 영역 분할: 상단 50%, 하단 50%
	float topHeight = totalHeight * 0.5f;  
    ...
    DrawText(graphics, m_strText1, m_strFont1, 30, FontStyleBold, layoutRect1, m_textcolor1, Color(0, 0, 0, 0), 1);
    DrawText(graphics, m_strText2, m_strFont2, 24, FontStyleRegular, layoutRect2, m_textcolor2, Color(0, 0, 0, 0), 2);
...
{   
    ...
    Gdiplus::FontFamily fontFamily(A2W(strFontName));
    Gdiplus::Font font(&fontFamily, fontSize, fontStyle, UnitPixel);


    RectF textRect;
    graphics.MeasureString(A2W(strText), -1, &font, fRect, NULL, &textRect);
